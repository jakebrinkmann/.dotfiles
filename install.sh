...
stow --adopt -t ~ bash git nvim brew ripgrep python psql zsh bin ssh task jq ghostty act copilot ollama opencode
...
confirm "Install Ollama?" &&
  ...
  npx agentic-awesome-skills --path ~/.config/opencode/skills --category development,backend,meta,productivity &&
